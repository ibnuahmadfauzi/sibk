...
class FoundationDataTest extends TestCase
{
    ...
    public function test_foundation_seeders_are_idempotent(): void
    {
        ...
        $this->assertSame(55, ReferenceValue::query()->count());
        $this->assertSame(5, ReferenceValue::query()->forCategory('case_status')->count());
        $this->assertSame(5, ReferenceValue::query()->forCategory('consultation_status')->count());
