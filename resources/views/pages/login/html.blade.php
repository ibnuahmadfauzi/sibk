    ...
    <section class="sibk-auth-brand" aria-labelledby="auth-brand-title">
        <div class="sibk-auth-brand__inner">
            ...
            <div class="sibk-auth-illustration" aria-hidden="true">
                <img
                    src="{{ asset('assets/images/illustration-consultation.png') }}"
                    alt=""
                    width="520"
                    height="380"
                    loading="lazy">
        ...
        <div class="sibk-auth-card card border-0">
            ...
            <div
                ...
                <div>
                    ...
                    <a
                        ...
                        href="{{ route('dashboard.preview', ['role' => 'guru']) }}">
            ...
            <form
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group @error('email') is-invalid @enderror @error('credentials') is-invalid @enderror">
                        ...
                        <input
                            ...
                            aria-describedby="identifierError{{ $errors->has('credentials') ? ' credentialsError' : '' }}">
                    </div>

                    @error('email')
                        <div class="invalid-feedback d-block" id="identifierError">
                            {{ $message }}
                        </div>
                    @else
                        <div
                            class="invalid-feedback @if ($errors->has('credentials')) d-none @endif"
                            id="identifierError">
                            Email wajib diisi.
                        </div>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group @error('password') is-invalid @enderror @error('credentials') is-invalid @enderror">
                        ...
                        <input
                            class="form-control @error('password') is-invalid @enderror @error('credentials') is-invalid @enderror"
                            id="password"
                            name="password"
                            type="password"
                            required
                            ...
                            aria-describedby="passwordError{{ $errors->has('credentials') ? ' credentialsError' : '' }}">

                        <button
                            class="btn sibk-password-toggle"
                            id="togglePassword"
                            type="button"
                    ...
                    @error('credentials')
                        <div class="invalid-feedback d-block" id="credentialsError">
                            {{ $message }}
                        </div>
                    @enderror
                </div>
                ...
                <button
                    class="btn btn-primary sibk-auth-submit w-100"
                    id="loginButton"
                    type="submit">
            ...
            <div class="sibk-auth-help">
                ...
                <span>
                    ...
                    <strong>Hubungi Admin IT sekolah.</strong>
                </span>
            </div>
