<div class="login-wrapper">
    ...
    <section class="login-info">
        <div class="login-info-inner">
            ...
            <div class="brand-header">
                ...
                <span class="brand-name">APLIKASI BK</span>
            </div>

            {{-- Tagline --}}
            <div class="login-info-body">
                <h1 class="info-tagline">
                ...
                <div class="info-illustration">
                    <img src="/assets/images/counseling-illustration.jpg" alt="Ilustrasi layanan konseling" class="illustration-img">
                </div>
            </div>
    ...
    <section class="login-form-wrapper">
        <div class="login-card">
            ...
            <h2 class="login-title">Masuk ke Aplikasi BK</h2>
            ...
            <form action="#" method="POST" id="loginForm">
                ...
                <div class="field-group">
                    <label for="identifier" class="field-label">Nama pengguna atau email</label>
            ...
            <a href="mailto:admin@sekolah.sch.id" class="btn-help">
