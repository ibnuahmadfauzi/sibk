...
@section('body')
    <div class="sibk-dashboard" data-page-id="PG-201">
        ...
        <div class="sibk-panel mb-4"><div class="sibk-panel__body p-4"><form class="row g-3 align-items-end" action="{{ route('students.index') }}" method="GET">
