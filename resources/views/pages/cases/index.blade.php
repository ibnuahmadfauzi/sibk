    ...
    <div class="sibk-dashboard" data-page-id="PG-101">
        ...
        @if($activeTab === 'kasus')
            ...
            <div class="table-responsive"><table class="table sibk-table mb-0 align-middle"><thead><tr>
                ...
                <th><a href="{{ $sortUrl('bidang') }}">Jenis Masalah</a></th>
                    ...
                    <tr @unless($isWakaOnly)data-modal-url="{{ route('cases.show', [$case, 'modal' => 1]) }}"@endunless>
                        ...
                        <td><div class="d-flex flex-wrap gap-1">
                            ...
                            <a href="{{ route('cases.edit', $case) }}" data-modal-url="{{ route('cases.edit', [$case, 'modal' => 1]) }}"
                                    @if($completed) data-confirm-message="Permasalahan ini telah selesai. Apakah Anda ingin melanjutkan pengeditan?" onclick="if (! window.confirm('Permasalahan ini telah selesai. Apakah Anda ingin melanjutkan pengeditan?')) { event.stopImmediatePropagation(); return false; }" @endif
