                ...
                <div class="col-12 col-md-6">
                    <div class="sibk-report-card h-100">
                        <div class="sibk-report-card__body">
                            <div class="sibk-report-card__icon-wrapper {{ $report['bg_class'] ?? '' }}" style="background-color: {{ $report['badge_bg'] ?? '#e9f2fb' }}; color: {{ $report['icon_color'] ?? '#2f6fc6' }};">
                        ...
                        <div class="sibk-report-card__footer">
                            <a href="{{ route('reports.preview', ['type' => $report['id']]) }}" class="sibk-report-card__action">
                                <span>Buka</span>
