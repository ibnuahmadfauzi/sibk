                    ...
                    @foreach($preparationYears as $year)
                        ...
                        <div class="border rounded-3 p-3">
                            ...
                            @if(! $year->is_active && $year->activated_at === null)
                                ...
                                >Batalkan persiapan</button>
                                <div class="modal fade" id="delete-year-{{ $year->id }}" tabindex="-1" aria-labelledby="delete-year-title-{{ $year->id }}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h2 class="modal-title fs-5" id="delete-year-title-{{ $year->id }}">Batalkan persiapan {{ $year->name }}?</h2>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('data-master.academic-years.destroy', $year) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
