...
- **Field dan completeness:** adapter hanya memakai exact field resmi; missing collection, tipe/nullability salah, full marker tidak eksplisit, page/identitas tidak konsisten, atau jawaban berubah di tengah pagination ditolak sebelum mutasi. Dapodik full snapshot tanpa tahun ajaran atau murid selalu ditolak. e-Tatib full snapshot kosong hanya diterima dengan marker completeness dan total nol terverifikasi dari kontrak resmi.
