...
- Strategi revision provenance untuk perubahan record:
...
- Format timestamp:
- Presisi timestamp:
- Semantik waktu kejadian, perubahan, dan sinkronisasi:
...
- Aturan validator untuk schema, tipe, nullability, identitas, batas, dan revision provenance:
