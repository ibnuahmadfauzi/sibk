...
| REP-02  | Laporan harus menampilkan satu baris per catatan kasus/konsultasi dengan No, Hari/Tanggal, Nama & Kelas, Layanan/Jenis Masalah, Latar Belakang Masalah ringkas, Penanganan ringkas, serta Aksi. | P0 | Ikon mata membuka/meringkas narasi lengkap; ikon chevron membuka baris Hasil Layanan dengan latar berbeda; Hapus memakai archive/soft delete sesuai policy. Klik baris tidak membuka modal dan cetak per catatan tidak ditampilkan. |
