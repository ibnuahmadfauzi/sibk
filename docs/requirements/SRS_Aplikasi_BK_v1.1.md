...
| MD-05  | Admin IT harus dapat membuat tahun ajaran operasional tanpa memasukkan tanggal mulai atau tanggal selesai. | P0 | Tahun ajaran baru menyimpan nama/identitas tahun dan selalu dibuat `is_active=false`; waktu serta actor aktivasi dicatat ketika Koordinator mengaktifkannya. Admin IT dapat menghapus draf Persiapan hanya jika belum pernah aktif dan belum memiliki data terkait; penghapusan diaudit. |
