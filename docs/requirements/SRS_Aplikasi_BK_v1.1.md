...
| Endpoint fail-closed           | Origin cocok exact dengan allowlist deployment; redirect, user-info, query/fragment, origin drift, metadata/link-local, DNS campuran/berubah, proxy tak tepercaya, dan TLS invalid ditolak. |
