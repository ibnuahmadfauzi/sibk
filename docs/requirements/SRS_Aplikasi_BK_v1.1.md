...
| MD-05  | Admin IT harus dapat membuat tahun ajaran operasional tanpa memasukkan tanggal mulai atau tanggal selesai. | P0 | Tahun ajaran baru menyimpan nama dua tahun berurutan dan selalu dibuat `is_active=false`; rentang internal Juli–Juni dihitung otomatis untuk kompatibilitas impor dan laporan. Waktu serta actor aktivasi dicatat ketika Koordinator mengaktifkannya. Admin IT dapat menghapus draf Persiapan hanya jika belum pernah aktif dan belum memiliki data terkait; penghapusan diaudit. |
...
- Draf Persiapan yang kosong dapat dihapus Admin IT setelah pemeriksaan relasi dan audit. Tahun yang pernah aktif, roster, penugasan, serta riwayat layanan tidak ikut dihapus. Pengembalian ke tahun aktif sebelumnya hanya tersedia bagi Koordinator bila pendahulu dapat dipastikan dan belum ada aktivitas operasional setelah aktivasi; jika tidak, koreksi dilakukan di luar aksi otomatis.
