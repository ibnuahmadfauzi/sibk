...
| Fallback     | Bila Dapodik terlambat 2–3 bulan, Admin IT menyiapkan tahun ajaran tanpa input tanggal periode dan mengimpor URL API Siswa sekali pakai atau CSV minimum seluruh murid aktif berupa `nisn,nama,rombel,tahun_pelajaran` berdasarkan dasar resmi sekolah; satu berkas dapat memuat beberapa tahun yang sudah dibuat; Koordinator mengaktifkan setelah data dan penugasan lengkap. |
