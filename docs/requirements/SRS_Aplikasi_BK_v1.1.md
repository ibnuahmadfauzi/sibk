...
| ASN-02 | Perubahan membership murid dan penugasan Guru BK harus berupa perubahan state pada tahun ajaran yang sama. | P0 | Admin IT mengelola daftar rombel aktif di Data Kelas; rombel baru tersedia pada tahun berjalan dan Persiapan, perubahan nama/status tidak mengubah tahun yang selesai. Koordinator dapat menugaskan kelas kosong dan membatalkan penugasan setelah konfirmasi; nilai sebelum/sesudah dicatat pada audit tanpa histori periode tanggal. |
...
| INT-14  | Pratinjau URL e-Tatib harus menahan penerapan data yang berubah atau diduga tidak lengkap. | P0 | Admin IT melihat jumlah data dan identitas konflik beserta kelas tanpa rincian pelanggaran. Sinkronisasi sekali pakai/aktivasi otomatis hanya berlaku untuk hasil pratinjau yang sama. Jika ada pelanggaran aktif sebelumnya yang hilang dari respons, sinkronisasi manual maupun terjadwal gagal tanpa mengubah mirror; Admin IT memeriksa kelengkapan di sumber. |
