...
| REP-03  | Halaman utama harus memakai pagination 10/25/50/100 dan urutan tanggal terbaru; preview rekap, cetak/PDF browser, Excel, dan Word memakai seluruh dataset hasil filter dengan urutan tanggal paling awal. | P0 | Default UI 10 data; ringkasan hasil filter yang sama ikut tampil pada preview/PDF, Excel, dan Word; dokumen menampilkan Hari/Tanggal, Nama/Kelas, jenis catatan dan bidang layanan, Permasalahan, Penanganan beserta hasil, serta Tindak Lanjut/Status; waktu layanan tidak ditampilkan karena tidak disimpan. |
