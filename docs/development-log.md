...
- Riwayat Tindak Lanjut tetap di luar scope. Pint, build frontend, Composer
  strict, dan pemeriksaan diff lulus; automated test serta checker frontend
  tidak dijalankan sesuai instruksi pengguna.
