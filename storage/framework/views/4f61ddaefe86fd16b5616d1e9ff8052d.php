<?php $__env->startSection('page-title', 'Tambah Akun - Ruang BK'); ?>
    ...
    <div class="sibk-dashboard">
        ...
        <div class="sibk-page-header d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
            <div class="d-flex align-items-center gap-3">
                <a href="<?php echo e(route('account.preview')); ?>" class="btn btn-icon btn-light" aria-label="Kembali">
        ...
        <form action="#" method="POST">
            ...
            <div class="d-flex justify-content-end gap-3 mt-4 mb-5">
                <a href="<?php echo e(route('account.preview')); ?>" class="btn fw-bold px-5 py-2 rounded-pill shadow-sm" style="color: #2b5cff; background-color: #ffffff; border: 1px solid #e2e8f0;">Batal</a>
...
<?php echo $__env->make('layouts.app-2', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Tugas\pepe g\smt 2\pk\sibk\sibk\resources\views\pages\account\create.blade.php ENDPATH**/ ?>